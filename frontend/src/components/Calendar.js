...
const Calendar = ({ 
  ...
  useEffect(() => {
    setFilteredVacations(
      vacations.filter(v => v.year === year && v.month === month)
    );
  }, [vacations, month, year]);
  ...
  const handleEmployeeClick = (employee) => {
    const employeeVacation = filteredVacations.find(v => v.employeeId === employee.id);
    setSelectedEmployee({
      ...employee,
    ...
    <div className="calendar-container">
      ...
      <div className="calendar-content">
        ...
        <div className="calendar-grid">
          ...
          {filteredEmployees.map(employee => {
            const vacation = filteredVacations.find(v => v.employeeId === employee.id);
            return (
